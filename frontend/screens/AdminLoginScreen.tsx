import {
  ...
  const AdminLoginScreen: React.FC<Props> = ({ navigation }) => {
    ...
    const isFormValid = () => {
      ...
      if (isNewAccount && !schoolName) return false;
      return true;
    };
    ...
    const handleSubmit = () => {
      ...
      if (isNewAccount) {
        // Create new account logic would go here
            ...
            <View style={styles.container}>
              ...
              <View style={styles.header}>
                ...
                >
                  ...
                  <Text style={styles.subtitle}>{isNewAccount ? 'Sign Up' : 'Login'}</Text>
                </Animated.View>
              </View>
              ...
              <View style={styles.formContainer}>
                ...
                {/* School Name Field (only for new account) */}
                {isNewAccount && (
                  <>
                ...
                >
                  ...
                  >
                    <Text style={styles.loginButtonText}>{isNewAccount ? 'Create Account' : 'Login'}</Text>
                  </LinearGradient>
                </TouchableOpacity>
                ...
                <View style={styles.createAccountContainer}>
                  ...
                  <TouchableOpacity onPress={() => setIsNewAccount(!isNewAccount)}>
                    <Text style={styles.createAccountLink}>
                      {isNewAccount ? 'Login' : 'Create new'}
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
